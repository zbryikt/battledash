...
(function(){
  ...
  (function(it){
    ...
    app.get('/b/:key/dashboard', aux.signed, function(req, res){
      if (!req.user) {
        return aux.r403(res);
      }
      return io.query("select * from board where key = $1", [req.params.key]).then(function(r){
        ...
        return res.render('b/dashboard/index.pug', {
          board: board
        });
      })['catch'](aux.errorHandler(res));
    });
    api.post('/board', aux.signed, expressFormidable(), function(req, res){
      ...
      return io.query("select key from board where slug = $1", [slug]).then(function(r){
        ...
        return new Promise(function(res, rej){
          ...
          return fsExtra.ensureDir(root, function(e){
            ...
            return sharp(thumb).toFile(path.join(root, slug + ".png"), function(e, i){
              if (e) {
                return rej(e);
              } else {
                return res();
    ...
    return api.post('/board/slug-check', function(req, res){
      return io.query("select key from board where slug = $1", [req.body.slug]).then(function(r){
        r == null && (r = {});
        return res.send({
